...
namespace TimeBeam
{
    ...
    public partial class Timeline : Control
    {
        ...
        /// </summary>
        private const float DRAGGING_THRESHOLD = 3f;
...
//        }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (e.Location == oldLocation) // TODO KBR tooltip causing infinite mouse move events?
                return;
            ...
            if ((e.Button & MouseButtons.Left) != 0)
            {
                ...
                else if (CurrentMode == BehaviorMode.RequestMovingSelection || CurrentMode == BehaviorMode.RequestResizingSelection)
                {
                    ...
                    if (Math.Sqrt(delta.X * delta.X + delta.Y * delta.Y) > DRAGGING_THRESHOLD)
                    {
            ...
            else
            {
                ...
                {
                    toolTip1.Show(focusedTrack.Name, this);
                    //toolTip1.Active = false;
                    //toolTip1.SetToolTip(this, focusedTrack.Name);
