...
namespace WordCloud
{
    public class CloudControl : Panel
    {
        ...
        readonly Color[] m_DefaultPalette = { Color.DarkRed, Color.DarkBlue, Color.DarkGreen, Color.Navy, Color.DarkCyan, Color.DarkOrange, Color.DarkGoldenrod, Color.DarkKhaki, Color.Blue, Color.Red, Color.Green };
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            Point mousePositionRelativeToControl = PointToClient(new Point(MousePosition.X, MousePosition.Y));
